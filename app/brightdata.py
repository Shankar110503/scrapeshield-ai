...
class BrightDataClient:
    ...
    def trigger(self, inputs: List[Dict[str, Any]]) -> str:
        response = requests.post(
            ...
            params={"collector": self.collector, "queue_next": "1"},
    ...
    def dataset(self, collection_id: str) -> Optional[List[Dict[str, Any]]]:
        # Bright Data Scraper Studio collectors use /dca/dataset
        # for the result of a /dca/trigger run. The trigger returns
        # collection_id; the dataset endpoint expects the same value
        # under the query parameter name `id`.
        #
        # Do NOT use /dca/get_result here: that endpoint expects a
        # different async API identifier named `response_id`.
